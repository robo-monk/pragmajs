...
//  -------------------------------
  ...
  from(pragma){
    if (pragma.exports){
      util$1.mimic(this, pragma, pragma.exports);
...
export { ActionChain, Pragma, _e, _p$1 as _p, _runAsync, _thread, globalify, render, runAsync, index as util, π };
