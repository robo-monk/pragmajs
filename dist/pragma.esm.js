...
class Comp extends Pragma {
  ...
  pragmatize(where){
    ...
    $$1(where ? where : document.body).append(this.element);
  ...
  compose(force=false, tag="div"){
    ...
    return this.as($$1(document.createElement(tag)))
  }
  ...
  build(map){
    ...
    if (map.element) this.element = $$1(map.element);
...
export { Bridge, Button, Comp, Compose, IconBuilder, Monitor, Pragma, Select, Slider, Value, Variants, at, contain, host, parse, pragmatize };
