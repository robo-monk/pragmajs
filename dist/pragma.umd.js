	...
	*/
	...
	class Comp extends Pragma {
	  ...
	  pragmatize(where){
	    ...
	    jquery(where ? where : document.body).append(this.element);
	  ...
	  compose(force=false, tag="div"){
	    ...
	    return this.as(jquery(document.createElement(tag)))
	  }
	  ...
	  illustrate(icon){
	    if (!this.icon) {       
	      this.icon = jquery(document.createElement("div"));
	  ...
	  build(map){
	    ...
	    if (map.element) this.element = jquery(map.element);
